...
{
    public class TransportOrderVTPDTO
    {
        ...
        public List<ProductVTPDTO> LIST_ITEM { get; set; }
    }

    public class ProductVTPDTO
    {
        public string PRODUCT_NAME { get; set; }
        public int PRODUCT_PRICE { get; set; }
        public int PRODUCT_WEIGHT { get; set; }
    ...
    // trời xanh mây trắng, xuôi dòng Cửu Long Giang
    // mênh mông rừng tràm, bạt ngàn ldừa xanh
    // //
    // từng chan nước đong đưa
    // nhớ người xưa từng ở nơi này
    // cho ta thêm yêu dấu chân ngàn năm đi mở đất
    public class PriceAllVTPDTO
    {
        public int SENDER_PROVINCE { get; set; }
        public int SENDER_DISTRICT { get; set; }
        public int RECEIVER_DISTRICT { get; set; }
