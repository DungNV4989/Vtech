    ...
    public partial class update_context : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Code = table.Column<string>(type: "nvarchar(max)", nullable: true, defaultValueSql: "FORMAT(NEXT VALUE FOR BillCustomerProductBonusCode,'0000000000')"),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Code = table.Column<string>(type: "nvarchar(max)", nullable: true, defaultValueSql: "FORMAT(NEXT VALUE FOR BillCustomerProductCode,'0000000000')"),
                    ProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Code = table.Column<string>(type: "nvarchar(max)", nullable: true, defaultValueSql: "FORMAT(NEXT VALUE FOR BillCustomerCode,'0000000000')"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PriceTableProducts", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConfirmedAccumulatedBeforeCNY = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ConfirmedAccumulatedCNY = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ...
                    ConfirmedAccumulatedVND = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ConfirmedAccumulatedBeforeVND = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ConfirmedFinalVND = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    IsPaidFinalize = table.Column<bool>(type: "bit", nullable: false),
                    IsDeliveryFinalize = table.Column<bool>(type: "bit", nullable: false),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
