        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDebtAccount = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BeginOfPeriodReceivable = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    BeginOfPeriodPayable = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PeriodReceivable = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PeriodPayable = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    EndOfPeriodReceivable = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    EndOfPeriodPayable = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DebtReports", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Receivable = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EntryAccounts", x => x.Id);
                });
